...
// Se puede usar para cualquier proyecto que necesite conectarse a una BD 
// (discografía, Pokémon, libros, películas, etc.)
class Conexion{
    public $ip;        // IP o nombre del servidor de la base de datos
    ...
    // Se usa cuando el proyecto emplea funciones mysqli para consultas simples
